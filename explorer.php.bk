...
//
$_CONFIG['main_title'] = "DACC Document Explorer";
...
//
$_CONFIG['starting_dir'] = "./documents/";
...
if($this->files)
{
	...
	foreach ($this->files as $file)
	{
		...
		print "<td class=\"name\">\n";
		print "\t\t<a href=\"editDocument.php?document=".$this->location->getDir(false, true, false, 0).$file->getNameEncoded()."\"";
